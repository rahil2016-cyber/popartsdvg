...
import { Gift, Package, LogOut, Heart, PlayCircle } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white shadow-lg p-6 space-y-6">
        ...
        <nav className="space-y-2">
          ...
          <Link to="/admin/categories" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-purple-50 text-purple-700 font-semibold">
