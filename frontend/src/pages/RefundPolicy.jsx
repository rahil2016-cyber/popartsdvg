    ...
    <div className="max-w-4xl mx-auto px-4 py-16 text-gray-800">
      ...
      <div className="space-y-6 text-lg">
        ...
        <section>
          ...
          <p>We strive to deliver the best quality products. Due to the personalized nature of our items, <strong>we strictly do not accept returns, and we do not offer any exchanges or refunds</strong>.</p>
        </section>
